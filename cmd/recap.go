...
var recapCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cmd.Println()
		cmd.Println("Agent install")
		cmd.Println("  faz install codex         Install Codex skill, context, and SessionStart hook")
		cmd.Println("  faz install claude        Install Claude skill, context, and SessionStart hook")
		cmd.Println("  faz install codex --local Install into current Git repository")
		cmd.Println("  faz install claude --local Install into current Git repository")
		cmd.Println()
		...
		cmd.Println("  install  Install Codex or Claude integration")
		cmd.Println("  completion Generate shell completions")
		cmd.Println()
		cmd.Println("Version")
		cmd.Println("  faz -v")
		cmd.Println()
		cmd.Println("Type reminder")
